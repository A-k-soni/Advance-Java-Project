...
<body>
	<div class="container-fluid d-flex justify-content-center" style="height: 100vh ;background: linear-gradient(rgba(0, 0, 0, 0.4),rgba(0, 0, 0, 0.4)),url(ff.jpg);
 		background-size:cover;background-position:center; background-repeat:no-repeat">
	<nav
      class="navbar navbar-expand fixed-top text-light navbar-dark bg-dark justify-content-between"
    >
      <div class="nav navbar-nav">
        <a class="nav-item nav-link active" href="grocery_list.htm" style="font-weight: bolder;font-size: 20px;text-shadow: 2px 2px 5px red">Back</a>
      </div>
    ...
    <div class="container-fluid" style="margin-top:150px">
     	<spr:form action="grocery_update.htm" method="post" commandName="grocery" >
	<table align="center" >
		<tr>
			<td>
			...
			<td>
				<spr:hidden path="groceryId"/>
			</td>
		</tr>
		<tr>
			<td>
				<h4 style="color: gold;font-weight: bolder; text-shadow: 2px 2px 3px red;">Item :</h4>
			</td>
			<td>
				<div class="form-group">
                  <spr:input class="form-control" placeholder="Enter Item Name" path="itemName"/>
                  <font style="color: gold;text-shadow: 2px 2px 3px black;font-weight: bolder;" ><spr:errors path="itemName"/></font>
                </div>
			</td>
		</tr>
		<tr>
			<td>
				<h4 style="color: gold;font-weight: bolder; text-shadow: 2px 2px 3px red;">Quantity :</h4>
			</td>
			<td>
				<div class="form-group">
                  <spr:input class="form-control" type="number" id="quantity" name="quantity" min="1" max="5000000"
		...
		<tr>
			<td>
				<h4 style="color: gold;font-weight: bolder; text-shadow: 2px 2px 3px red;">Price : </h4>
			</td>
			<td>
				<div class="form-group">
                  <spr:input class="form-control" type="number" id="quantity" name="quantity" min="1" max="5000000" 
                   placeholder="Enter Quantity" path="price"/>
                </div>
			</td>
		</tr>
		<tr>
			<td>
				<h4 style="color: gold;font-weight: bolder; text-shadow: 2px 2px 3px red;">Purchase Date :</h4>
			</td>
			<td>
				<div class="form-group">
		...
		<tr>
			<td>
				<h4 style="color: gold;font-weight: bolder; text-shadow: 2px 2px 3px red;">Expiry Date:</h4>
			</td>
			<td>
				<div class="form-group">
                  <spr:input class="form-control" type="date" placeholder="Enter Quantity" path="expiryDate"/>
                   <font style="color: gold;text-shadow: 2px 2px 3px white; font-weight: bold;" ><spr:errors path="expiryDate"/></font>
                </div>
			</td>
		</tr>
