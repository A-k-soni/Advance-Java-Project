...
<body>
	<div  class="container-fluid d-flex justify-content-center" style="height: 100vh ;background: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.2)),url(page2_img1.jpg);
        ...
        >
          ...
          <div class="row shadow ml-0 mr-5">
            ...
            <div
              ...
              style="height: 50vh; background: whitesmoke ; box-shadow:  2px 2px 5px  0 grey;" 
            >
              ...
              <spr:form action="login.htm" method="post" commandName="user">
	                ...
	                <div id="alt" style="color: red">${Invalid_Credentials}</div>
	                <div class="form-group">
	                  <spr:input class="form-control" placeholder="Enter Email" path="email"/>
	                ...
	                <div class="form-group">
	                  <a href="prep_forgot_form.htm">Forgot Password?</a>
	                  <a href="prep_reg_form.htm">Not Registerd?</a>
	                </div>
              </spr:form>
            </div>
          </div>
